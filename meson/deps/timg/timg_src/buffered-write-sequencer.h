...
public:
  ...
  BufferedWriteSequencer(int fd, bool allow_frame_skipping, int max_queue_len, bool debug_no_frame_delay, const volatile sig_atomic_t &interrupt_received);
  ...
  void WriteBuffer(char *buffer, size_t size, SeqType sequence_type, const Duration &end_of_frame = {});
